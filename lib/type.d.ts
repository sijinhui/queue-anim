...
export type INumberOrArrayOrFunc = number | [number, number] | ((e: {
    key: string;
    index: number;
}) => number | number[]);
export type IEaseType = IEase | [number, number, number, number];
export type IQueueTypeOrArrayOrFunc = IQueueType | [IQueueType, IQueueType] | ((e: {
    key: string;
    index: number;
}) => IQueueType | [IQueueType, IQueueType]);
export type IEaseTypeOrArrayOrFunc = IEaseType | IEaseType[] | ((e: {
    key: string;
    index: number;
}) => IEaseType | IEaseType[]);
export type IAnimConfigOrArrayOrFunc = {} | [{}] | ((e: {
    key: string;
    index: number;
}) => {} | {}[]);
...
export interface IProps extends Omit<AllHTMLAttributes, 'type'> {
    ...
    appear?: boolean;
    component?: string | React.ClassType<any, React.Component, React.ComponentClass<any>> | React.ForwardRefExoticComponent<IProps & {
        ref?: React.Ref<any>;
    }> | undefined;
